...
opt = list(phenodata = "/scratch2/NSF_GWAS/notebooks/InPlantaGWAS/02_Parsing_phenodata/pheno_files/callus_and_PCs/",
           covariates = "/scratch2/NSF_GWAS/notebooks/InPlantaGWAS/02_Parsing_phenodata/covariate_files/Covariates_AllPhasesButLast_Stem_PC123maf05_noheader.txt",
           ...
           job_id = "mtskat_with_PCs_added_over_callus_and_PCs_w_05maf",
           window_size = 3000,
           window_shift = 1000,
           mode = "sequential",
           n_thread = 40)
