...
#' @param upper_bound_leading_0s_null_model_par numeric, limit x to end resampling for SNP windows with p-values above 10^-x, usually due to computational cost
...
#'
#' @examples
MTMCSKAT_workflow <- function(phenodata, covariates, raw_file_path, window_size, window_shift, output_dir = "/scratch2/NSF_GWAS/Results/SKAT/", ncore="AllCores",
